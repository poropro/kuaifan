...
<div class="daohang"><a href="{#kf_url('index')#}">首页</a> &gt; 会员中心</div>

<div class="m_title">基本资料</div>
	<div class="pnpage">
		...
		账户余额: <font style="color:#F00;font-weight:700">{#$huiyuan.amount#}</font>{#$KUAIFAN.amountname#}, <font style="color:#F00;font-weight:700">{#$huiyuan.point#}</font>积分<br/>
	</div>

{#$link = get_link('m|c|a')#}
<div class="m_title">管理中心</div>
	<div class="pnpage">
