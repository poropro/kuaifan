...
<ul id="listHtml">
<!-- list start -->
{#kuaifan_neirong catid={#$M.arrchildid#} set="列表名:lists,显示数目:20,模型:{#$M.module#},状态:1,搜索变量名:key,标题长度:30,填补字符:...,分页显示:1,分页名:pagelist,分页变量名:page"#}
