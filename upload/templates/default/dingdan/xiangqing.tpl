...
<a href="{#kuaifan getlinks='vs|sid'#}&amp;m=huiyuan&amp;c=index">会员中心</a>&gt;<a href="{#kuaifan getlink='c|id'#}&amp;c=index">我的订单</a><br/>
------------- <br/>
{#if $dingdan.maijia#}
	【卖家信息】
	{#$isvip = get_vip($dingdan.maijia)#}
	<br/>昵称: <a href="{#kuaifan getlinks='vs|sid'#}&amp;m=huiyuan&amp;c=ziliao&amp;userid={#$dingdan.maijia.userid#}">{#$dingdan.maijia.nickname#}</a>
...
<br/>
【订单信息】
	<br/>产品标题: {#if $dingdan.titleurl#}<a href="{#$dingdan.titleurl#}">{#$dingdan.title#}</a>{#else#}{#$dingdan.title#}{#/if#}
	<br/>订单编号: {#$dingdan.id#}
