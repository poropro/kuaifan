...
"#}
{#include file="common/header.tpl" title="账户记录"#}
...
{#kuaifan_jiangfa set="列表名:lists,会员ID:{#$huiyuan.userid#},币种:GET[type],类型:GET[add],搜索变量名:key,显示数目:10,标题长度:15,填补字符:...,分页显示:1,分页名:pagelist,分页变量名:pp"#}
...
{#foreach from=$lists item=list#}
	<a href="{#$url#}&amp;id={#$list.id#}">{#$list.title#}</a><br/>
