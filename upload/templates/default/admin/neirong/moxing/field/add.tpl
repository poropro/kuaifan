...
<a href="{#kuaifan getlink='fadd'#}&amp;faddl=images">图片上传</a>:支持多图 <br/>
<a href="{#kuaifan getlink='fadd'#}&amp;faddl=downfile">文件上传</a>:支持多文件 <br/>
<a href="{#kuaifan getlink='fadd'#}&amp;faddl=wanneng">万能字段</a>:支持自写表单 <br/>
