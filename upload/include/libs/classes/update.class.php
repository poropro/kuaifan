...
class update {
	...
	function __construct() {
		$this->update_url = 'http://update.v9.kuaifan.net/index.php';
		$this->http = kf_class::run_sys_class('http','',1);
	...
	function module($type = '') {
		$string = '';
		$db = kf_class::run_model('pay_payment_model');
	...
	function check_uuid(){
		$site_db = kf_class::run_model('site_model');
